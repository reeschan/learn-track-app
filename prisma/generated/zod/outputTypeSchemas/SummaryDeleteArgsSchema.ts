...
export const SummaryDeleteArgsSchema: z.ZodType<Prisma.SummaryDeleteArgs> = z.object({
  select: SummarySelectSchema.optional(),
  include: SummaryIncludeSchema.optional(),
  where: SummaryWhereUniqueInputSchema,
}).strict() as z.ZodType<Prisma.SummaryDeleteArgs>;

export default SummaryDeleteArgsSchema;
