...
export const SummaryTagDeleteArgsSchema: z.ZodType<Prisma.SummaryTagDeleteArgs> = z.object({
  select: SummaryTagSelectSchema.optional(),
  include: SummaryTagIncludeSchema.optional(),
  where: SummaryTagWhereUniqueInputSchema,
}).strict() as z.ZodType<Prisma.SummaryTagDeleteArgs>;

export default SummaryTagDeleteArgsSchema;
