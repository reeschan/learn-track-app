...
export const SummaryUpdateArgsSchema: z.ZodType<Prisma.SummaryUpdateArgs> = z.object({
  select: SummarySelectSchema.optional(),
  include: SummaryIncludeSchema.optional(),
  data: z.union([ SummaryUpdateInputSchema,SummaryUncheckedUpdateInputSchema ]),
  where: SummaryWhereUniqueInputSchema,
}).strict() as z.ZodType<Prisma.SummaryUpdateArgs>;

export default SummaryUpdateArgsSchema;
