...
export const SummaryFindUniqueArgsSchema: z.ZodType<Prisma.SummaryFindUniqueArgs> = z.object({
  select: SummarySelectSchema.optional(),
  include: SummaryIncludeSchema.optional(),
  where: SummaryWhereUniqueInputSchema,
}).strict() as z.ZodType<Prisma.SummaryFindUniqueArgs>;

export default SummaryFindUniqueArgsSchema;
